...
/*   Updated: 2022/03/15 12:06:45 by ybestrio         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	data->north.img = mlx_xpm_file_to_image(data->mlx, data->txtr[0]/*"./north.xpm"*/, &data->north.w, &data->north.h);
	data->north.addr = mlx_get_data_addr(data->north.img, &data->north.bpp, &data->north.l_l, &data->north.endian);
	data->south.img = mlx_xpm_file_to_image(data->mlx, data->txtr[1]/*"./south.xpm"*/, &data->south.w, &data->south.h);
	data->south.addr = mlx_get_data_addr(data->south.img, &data->south.bpp, &data->south.l_l, &data->south.endian);
	data->west.img = mlx_xpm_file_to_image(data->mlx, data->txtr[2]/*"./west.xpm"*/, &data->west.w, &data->west.h);
	data->west.addr = mlx_get_data_addr(data->west.img, &data->west.bpp, &data->west.l_l, &data->west.endian);
	data->east.img = mlx_xpm_file_to_image(data->mlx, data->txtr[3]/*"./east.xpm"*/, &data->east.w, &data->east.h);
